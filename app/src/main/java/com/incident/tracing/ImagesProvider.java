...
public class ImagesProvider extends ContentProvider{
     ...
     * device.
     */
    public static final String CONTENT_AUTHORITY = "com.incident.tracing.imagecamerabitmap";
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (match) {
            case PICTURES:
                ...
                cursor = database.query(SQLiteHelper.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case PICTURES_ID:
